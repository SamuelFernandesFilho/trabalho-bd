...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Organização Superior</li>
	</ol>
</section>
...
<section class="content">
	<form class="form-inline">
  	<div class="form-group col-xs-6">
			<a type="button" href="<?php echo base_url('organizacaosup/adicionar')?>" class="btn btn-success">Adicionar organização superior</a>
		</div>
		<div class="form-group col-xs-6">
	...
	<table class="table table-striped">
		...
		<tbody>
			<tr>
				<td>1</td>
				<td>organição superior teste</td>
